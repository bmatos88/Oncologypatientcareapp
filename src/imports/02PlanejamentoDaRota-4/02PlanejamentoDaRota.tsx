import svgPaths from "./svg-2dr56t02mi";
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full whitespace-nowrap">
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[18px] overflow-hidden relative shrink-0 text-[14px] text-ellipsis" style={{ fontVariationSettings: "'wdth' 100" }}>
        Você tem disponível
      </p>
      <p className="font-['Titillium_Web:Bold',sans-serif] leading-[24px] not-italic overflow-hidden relative shrink-0 text-[20px] text-ellipsis">R$ 2589,99</p>
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[18px] overflow-hidden relative shrink-0 text-[14px] text-ellipsis" style={{ fontVariationSettings: "'wdth' 100" }}>
        na sua carteira
      </p>
    </div>
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center relative shrink-0 text-white w-full">
      <Frame7 />
      <div className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[0px] text-center w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="mb-0 text-[14px]">
          <span className="leading-[18px]">{`Informe seus `}</span>
          <span className="font-['Open_Sans:Bold',sans-serif] font-bold leading-[18px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            dados bancários
          </span>
        </p>
        <p className="leading-[18px] text-[14px]">para realizar o saque desse saldo</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0 w-full">
      <div className="bg-white h-[48px] relative rounded-[24px] shrink-0 w-full" data-name="Buttons">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center pl-[81px] pr-[80px] py-[16px] relative size-full">
            <p className="font-['Open_Sans:Bold',sans-serif] font-bold leading-[16px] relative shrink-0 text-[#ed1e79] text-[12px] text-center uppercase whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
              complete seu perfil
            </p>
          </div>
        </div>
...
function XCircle() {
  return (
    <div className="absolute left-[calc(75%+46px)] size-[36px] top-[-44px]" data-name="x-circle">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
        <g id="x-circle">
          <rect fill="var(--fill-0, white)" height="36" rx="18" width="36" />
          <path d={svgPaths.p2ba99ff0} id="Vector" stroke="var(--stroke-0, #666E80)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M22.5 13.5L13.5 22.5" id="Vector_2" stroke="var(--stroke-0, #666E80)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M13.5 13.5L22.5 22.5" id="Vector_3" stroke="var(--stroke-0, #666E80)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Frame3() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#ed1e79] bottom-[268px] content-stretch drop-shadow-[0px_17px_199.5px_rgba(0,0,0,0.07),0px_3.797px_44.561px_rgba(0,0,0,0.04),0px_1.131px_13.267px_rgba(0,0,0,0.03)] flex gap-[10px] items-end justify-center left-1/2 px-[16px] py-[32px] rounded-[24px] w-[328px]">
      <Frame />
      <XCircle />
    </div>
  );
...
export default function Component02PlanejamentoDaRota() {
  return (
    <div className="bg-[#f4f6f9] relative size-full" data-name="02-planejamento da rota">
      <MainContainer />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[rgba(34,42,67,0.75)] h-[800px] left-1/2 top-1/2 w-[360px]" data-name="Base/Color/Blue" />
      <Frame3 />
    </div>
  );
}